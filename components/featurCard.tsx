...
const FeatureCard = ({ cardData }: CardProps) => {
  ...
  return (
    <div className=" min-w-[25%] w-[280px] mx-h-[400px] h-[400px]  shadow shadow-lg rounded-b-xl group relative">
      ...
      <div className="hidden group-hover:flex w-[400px] overflow-hidden rounded-xl z-50 absolute top-0 bg-white shadow shadow-xl">
        <div>
        <div className="h-">
        <Image
          src={image}
