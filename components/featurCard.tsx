...
const FeatureCard = () => {
  return (
    <div className=" min-w-[25%] w-[27%] shadow shadow-lg rounded-b-xl">
        <div className="w-full bg-green-200 rounded-t-xl">
            <Image
                src="/pharm.png"
                height={500}
                width={500}
        ...
        <div className="px-3">
          <h1 className="font-bold text-lg py-4">First aide basics</h1>
          <p className="pb-10 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta harum tempore qui mollitia doloremque repudiandae asperiores eligendi tempora eum, corrupti rem! Corrupti est iure delectus!</p>
        </div>
        <div className="flex">
        {/* <div className='mt-20'>
