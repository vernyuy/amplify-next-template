                ...
                <div className='bg-bl mx-auto my-auto flex w-full h-full'>
                    ...
                    <form onSubmit={onSubmit}>
                        <div className='flex flex-col w-full mb-2'>
                            <label>Name</label>
                            <input type="text" disabled={isLoading}  name="username" className='h-9 border rounded-lg px-4 w-full'/>
                        </div>
                        <div className='flex flex-col mb-2'>
                            <label>Email</label>
                            <input type="text" disabled={isLoading}  name="email" className='h-9 border rounded-lg px-4 w-full'/>
                        </div>
                        <div className='flex flex-col mb-2'>
                            <label>Phone Number</label>
                            <input type="text" disabled={isLoading}  name="phoneNumber" className='h-9 border rounded-lg px-4 w-full'/>
                        </div>
                        <div className='flex flex-col mb-2'>
                            <label>Password</label>
                            <input type="text" disabled={isLoading} name="password" className='h-9 w-full border rounded-lg px-4'/>
                        </div>
                        <div className='flex flex-col mb-2'>
                            <label>Confirm Password</label>
                            <input type="text" name="confirmPassword" disabled={isLoading}  className='h-9 w-full border rounded-lg px-4'/>
                        </div>
                        {
                            isLoading
