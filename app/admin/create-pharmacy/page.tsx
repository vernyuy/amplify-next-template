                ...
                <div className='bg-bl mx-auto my-auto flex w-full h-full'>
                    ...
                    <form onSubmit={onSubmit}>
                        <div className='flex flex-col mb-2'>
                            ...
                            <input type="text" disabled={isLoading} name="name" className='h-9 border rounded-lg px-4 w-full'/>
                        </div>
                        <div className='flex flex-col w-full mb-2'>
                            <label>Description</label>
                            <input type="text" disabled={isLoading} name="description" className='h-9 border rounded-lg px-4 w-full'/>
                        </div>
                        {
                            isLoading
