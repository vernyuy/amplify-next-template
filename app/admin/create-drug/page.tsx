...
<div className='flex justify-evenly flex-wrap gap-4 p-4 sm:ml-64'>
    <div className='h-[100px] w-[180px] bg-blue-700 rounded-xl relative overflow-hidden'>
        ...
        <div className='bg-black/40 w-full absolute bottom-0 flex justify-center py-1 text-white'>hello</div>
    </div>
    <div className='h-[100px] w-[180px] bg-blue-700 rounded-xl relative overflow-hidden'>
        <div className='bg-black/40 w-full absolute bottom-0 flex justify-center py-1 text-white'>hello</div>
    </div>
                ...
                <div className='bg-bl mx-auto my-auto flex w-full h-full'>
                    ...
                    <form>
                        ...
                        <div className='flex flex-col w-full mb-2'>
                            <label>Code</label>
                            <input type="number" disabled={isLoading} name="confirmationCode" className='h-9 border rounded-lg px-4 w-full'/>
                        </div>
                        {
                            isLoading
